...
namespace MauiEcommerceDesign.Behaviors
{
    ...
    //public class ImageTappedBehavior : Behavior<Image>
    //{
    //    protected override void OnAttachedTo(Image obj)
    //    {
    //        var tapGestureRecognizer = new TapGestureRecognizer();
    //        tapGestureRecognizer.Tapped += View_Tapped;
    //        obj.GestureRecognizers.Add(tapGestureRecognizer);
    //        base.OnAttachedTo(obj);
    //    }

    //    protected override void OnDetachingFrom(Image obj)
    //    {
    //        var tapGestureRecognizer = new TapGestureRecognizer();
    //        tapGestureRecognizer.Tapped += View_Tapped;
    //        obj.GestureRecognizers.Add(tapGestureRecognizer);
    //        base.OnDetachingFrom(obj);
    //    }

    //    void View_Tapped(object sender, EventArgs e)
    //    {
    //        var image = (Image)sender;
    //        image.ScaleTo(1, 170, easing: Easing.Linear);
    //        image.ScaleTo(10, 170, easing: Easing.Linear);
    //        image.BackgroundColor = Color.Parse("Yellow");
    //    }
    //}
}
